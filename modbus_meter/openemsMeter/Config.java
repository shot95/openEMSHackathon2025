...
@ObjectClassDefinition(//
		name = "Voltfang Hackathon meter", //
		description = "Implements the meter for the Voltfang Hackathon.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Voltfang Hackathon [{id}]";
}